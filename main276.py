...
def balle_deplacement(x, y, dx, dy, brique_1, brique_2, brique_3, brique_4, brique_5, b_y, b_1_x, b_2_x, b_3_x, b_4_x, b_5_x):
    ...
    if y <= bord_haut + r:
        dy = -dy   
    if brique_1 == True:
        if x == b_1_x and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
        elif x == b_1_x + 16 and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
            ...
            dy = -dy
    if brique_2 == True:
        if x == b_2_x and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
        elif x == b_2_x + 16 and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
            ...
            dy = -dy
    if brique_3 == True:
        if x == b_3_x and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
        elif x == b_3_x + 16 and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
            ...
            dy = -dy
    if brique_4 == True:
        if x == b_4_x and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
        elif x == b_4_x + 16 and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
            ...
            dy = -dy
    if brique_5 == True:
        if x == b_5_x and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
        elif x == b_5_x + 16 and b_y + (r+5) <= y <= b_y + 4 + (r+5):
            dx = -dx
