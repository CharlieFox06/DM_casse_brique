...
def bounce_off_vaisseau(x, y, dx, dy, vaisseau_x, vaisseau_y):
    ...
    if (x == (vaisseau_x - 6) and y == (vaisseau_y - 4)) or (x == (vaisseau_x - 7) and y == (vaisseau_y - 3)) or (x == (vaisseau_x - 8) and y == (vaisseau_y - 2)) or (x == (vaisseau_x - 9) and y == (vaisseau_y - 1)) or (x == (vaisseau_x - 10) and y == (vaisseau_y)) or (x == (vaisseau_x - 11) and y == (vaisseau_y + 1)) or (x == (vaisseau_x - 12) and y == (vaisseau_y + 2)) or (x == (vaisseau_x - 13) and y == (vaisseau_y + 3)) or (x == (vaisseau_x - 14) and y == (vaisseau_y + 4)) or (x == (vaisseau_x - 15) and y == (vaisseau_y + 5)) or (x == (vaisseau_x - 16) and y == (vaisseau_y + 6)) or (x == (vaisseau_x - 17) and y == (vaisseau_y + 7)) or (x == (vaisseau_x - 18) and y == (vaisseau_y + 8)) or (x == (vaisseau_x - 19) and y == (vaisseau_y + 9)) or (x == (vaisseau_x - 20) and y == (vaisseau_y + 10)):
        dx = -dx
        dy = -dy
