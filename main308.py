...
def briques_reapparition(brique_1, brique_2, brique_3, brique_4, brique_5):
...
def update():
    ...
    brique_1, brique_2, brique_3, brique_4, brique_5 = briques_reapparition(brique_1, brique_2, brique_3, brique_4, brique_5)
